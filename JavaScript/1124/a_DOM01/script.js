...
document.addEventListener('DOMContentLoaded', () => {
  ...
  rects.forEach((rect, index) => {
    ...
    const source = `./cat.jpg`;
    // set과 getAttribute() 메소드를 사용하지 않고도 해당 요소에 .속성으로 바로 읽기가 가능
    rect.src = source;
...
//? 스타일 속성 지정 시 주의점
// style 속성은 객체
//  : 해당 객체 내부에서 CSS를 사용하여 스타일 속성을 지정
//  : 속성값는 CSS에서 사용하는 값과 동일
//  : 속성명의 경우
...
// 여러 개의 div 스타일을 조작하여 검은색에서 희색으로 그라데이션 효과를 보이도록 지정
document.addEventListener('DOMContentLoaded', () => {
