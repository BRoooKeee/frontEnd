...
// 문서 객체 생성 후에 '배치'
// 배치는 트리 구조로 전달
//  : 어떤 문서 객체가 있을 때 위에 있는 것을 '부모', 아래에 있는 것을 '자식'이라고 부른다.
...
//  : 따라서, 문서 객체를 다른 문서 객체에 추가할 경우 문서객체가 이동
document.addEventListener('DOMContentLoaded', () => {
...
// appendChild() 메소드 등으로 이미 부모 객체와 연결이 완료된 문서
//  : parentNode속성으로 부모 객체에 접근 가능
...
document.addEventListener('DOMContentLoaded', () => {
  setTimeout(() => {
    ...
    // h2.parentNode가 document.body이기 때문에 아래와 같이 작성
