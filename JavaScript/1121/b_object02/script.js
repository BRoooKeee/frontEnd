...
/*
프로토 타입 기반 언어
  : 객체를 원형(프로토 타입)으로 하는 복제 과정을 통해 객체의 동작 방식을 재사용 할 수 있게 하는 방법
  : 모든 객체들이 메소드와 속성들을 상속 받기 위한 템플릿으로써 프로토 타입 객체를 가짐
  : 정의된 객체를 기반으로 생성된 다른 객체들이 공통적으로 사용할 수 있는 속성과 메소드를 제공

  - 프로토 타입 체인
  : 프로토 타입은 해당 객체의 상위 객체로 부터 메소드와 속성을 상속받을 수 있음
...
let person1 = new Person('brooke', 'son', 20, 'male', 'music');
