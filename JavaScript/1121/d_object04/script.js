...
// 1. 자바스크립틔 원시 타입과 참조 타입을 기본 자료형과 객체 자료형으로 구분
let variable = 1;
variable = 'one';
variable = 'true';
...
// 함수는 '실행이 가능한 객체'
// '일급 객체'
// : 함수는 객체의 특성을 완별하게 구현가능하기 때문에 일급 객체로써 해당 자료형을 그대로 가짐
...
// : prototype 객체에 속성과 메소드를 추가하면 모든 객체(+기본자료형)에서 해당 속성과 메소드를 사용 가능
