...
//? JSON 구조
//  : JSON 내부에는 JS에서 사용할 수 있는 기본 데이터 타입인 문자열, 숫자, 배열, 불린, 그 밖의 다른 객체 또한 포함 가능
...
let data = [
  ...
  },
  {
    ...
    lecture: ['back-end', 'python', 'kotlin']
  }
];
