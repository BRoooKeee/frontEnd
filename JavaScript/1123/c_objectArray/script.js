...
// 조건문 연산자를 활용하여 간단하게 표시
// object.name
// object.hobby 속성의 여부를 확인
//  : 논리연산자(and, or, not)를 사용하여표시
...
// name속성을 aaa라는 이름, price속성을 bbb라는 이름으로 설정
...
// 출력
console.log(list1); // milk, bread, potato, tomato
console.log(list2); // milk, bread, potato, tomato

//  : 얕은 복사(참조 복사)는 서로 이름만 다를 뿐 서로 같은 메모리
...
const list4 = ['potato', 'juice'];
const list5 = ['onion', ...list3, ...list4];
console.log(list5); //['onion', 'milk', 'bread', 'potato', 'tomato', 'cheese', 'potato', 'juice']
