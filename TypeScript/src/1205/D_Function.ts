...
const arrowGreet: ArrowGreetType = (name) => `Helo, ${name}`;
console.log(arrowGreet('Lee'));

//! 선택적 매개변수와 기본 매개변수
// 선택적 매개변수는 함수 호출 시 생략 가능, 매개변수를 선택적으로 허용
...
console.log(select('hello', 'kim')); // kim hello
...
//! REST 매개변수
  : 함수에 여러 개의 매개 변수를 그룹화하여 배열로 전달하는 기능
...
console.log(greetEveryone('kim', 'lee', 'park'));

//? Rest 매개변수를 항상 마지막에 위치
...
console.log(add('hong', 'gildong')); //honggildong
